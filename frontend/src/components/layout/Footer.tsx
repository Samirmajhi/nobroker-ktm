      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">No-Broker Kathmandu</span>
            </div>
            <p className="text-gray-400 mb-4">
              Revolutionizing the rental market in Kathmandu by connecting tenants directly with property owners.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-400 text-center">
            © 2024 No-Broker Kathmandu. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
